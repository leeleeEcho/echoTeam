...
class OrderReturnPage extends Component {
    constructor(props) {
        super(props)
        this.state = {
        }
                    ...
                    <Layout style={{ padding: '0 24px 24px' }}>
                        ...
                        <Content className="page-content"  >
                            <Form className="page-content-form newTracklogform" onSubmit={this.handleSearch}>
                                ...
                                <Row>
                                    <Button type="primary" htmlType="submit"  >确认退货</Button>
...
const OrderReturnPageFrom = Form.create()(OrderReturnPage);


export default OrderReturnPageFrom;