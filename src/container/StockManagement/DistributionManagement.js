...
class DistributionManagement extends Component {
    ...
    render() {
        ...
        let columns = [
            ...
            { title: '配送人', dataIndex: 'capacity' },
            { title: '要货人', dataIndex: 'capacity' },
            { title: '配送到', dataIndex: 'capacity' },
            { title: '数量', dataIndex: 'price' },
            { title: '配送时间', dataIndex: 'price' },
            ...
            { title: '状态', dataIndex: 'status' },
            {
                title: '操作', dataIndex: 'actions', render: (text, record) => {
                    return (
                        <span>
                            <a><Link to='/stockdistribution'>修改</Link></a>
                        </span>
                    )
                }
            }
        ...
        return (
            <Layout className="page-layout">
                ...
                <Layout>
                    <StockMenu selected={['2']} openKeys={['sub2']} />
                    <Layout style={{ padding: '0 24px 24px' }}>
                        <Breadcrumb style={{ margin: '16px 0' }}>
                            <Breadcrumb.Item>配货管理</Breadcrumb.Item>
                            <Breadcrumb.Item>配货列表</Breadcrumb.Item>
                        </Breadcrumb>
                        <div className="page-top-button" >
                            <Button style={{ marginBottom: 16 }}><Link to="/stockdistribution">新增</Link></Button>
                        </div>
...
const DistributionManagementFrom = Form.create()(DistributionManagement);


export default DistributionManagementFrom;