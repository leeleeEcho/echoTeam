...
class StockReserve extends Component {
    constructor(props) {
        super(props)
        this.state = {
        }
                ...
                <Layout>
                    ...
                    <Layout style={{ padding: '0 24px 24px' }}>
                        <Breadcrumb style={{ margin: '16px 0' }}>
                            ...
                            <Breadcrumb.Item>新增预留</Breadcrumb.Item>
                        </Breadcrumb>
                            ...
                            <Form className="page-content-form newTracklogform" onSubmit={this.handleSearch}>
                                ...
                                >
                                    {getFieldDecorator('initupgrade', {
                                        ...
                                        <div>
                                            <Input />
                                            <span className="form-result-notice">*只能留10天</span>
                                        </div>
                                    )}
                                </FormItem>
...
const StockReserveFrom = Form.create()(StockReserve);


export default StockReserveFrom;