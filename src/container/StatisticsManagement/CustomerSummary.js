    ...
    render() {
        ...
        return (
            <Layout className="page-layout">
                ...
                <Layout>
                    <ReportMenu selected={['2']} openKeys={['sub1']} />
...
const CustomerSummaryFrom = Form.create()(CustomerSummary);

export default CustomerSummaryFrom;