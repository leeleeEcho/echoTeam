...
class CommoditySummary extends Component {
    constructor(props) {
        super(props)
        this.state = {
            curPage: 1,
    ...
    render() {
        ...
        let columns = [
            ...
            { title: '作者', dataIndex: 'customerphone' },
            { title: '成交总数', dataIndex: 'customerphone' },
            { title: '成交总金额', dataIndex: 'customerphone' },
            { title: '均价', dataIndex: 'customerphone' },
            { title: '上架数', dataIndex: 'customerphone' }
        ];
        const rowSelection = {
        ...
        return (
            <Layout className="page-layout">
                ...
                <Layout>
                    <ReportMenu selected={['3']} openKeys={['sub1']} />
...
const CommoditySummaryFrom = Form.create()(CommoditySummary);

export default CommoditySummaryFrom;