...
class AchievementSummary extends Component {
    ...
    render() {
        ...
        let columns = [
            ...
            { title: '业绩额', dataIndex: 'customerphone' },
            { title: '销售额', dataIndex: 'customerphone' }
        ];
        const rowSelection = {
        ...
        return (
            <Layout className="page-layout">
                ...
                <Layout>
                    <ReportMenu selected={['5']} openKeys={['sub1']} />
                    <Layout style={{ padding: '0 24px 24px' }}>
                        ...
                        <Form className="page-content-form" onSubmit={this.handleSearch}>
                            <Row>
                                ...
                                <Col span={6} >
                                    <FormItem label="组别" labelCol={{ span: 8 }} wrapperCol={{ span: 16 }}>
...
const AchievementSummaryFrom = Form.create()(AchievementSummary);

export default AchievementSummaryFrom;