    ...
    render() {
        ...
        return (
            <Layout className="page-layout">
                ...
                <Layout>
                    <ReportMenu selected={['4']} openKeys={['sub1']} />
                    <Layout style={{ padding: '0 24px 24px' }}>
                        <Breadcrumb style={{ margin: '16px 0' }}>
                            <Breadcrumb.Item>报表统计</Breadcrumb.Item>
                            <Breadcrumb.Item>销售统计</Breadcrumb.Item>
                        </Breadcrumb>
...
const SaleSummaryFrom = Form.create()(SaleSummary);

export default SaleSummaryFrom;