                ...
                <Layout>
                    ...
                    <Layout style={{ padding: '0 24px 24px' }}>
                        <Breadcrumb style={{ margin: '16px 0' }}>
                            ...
                            <Breadcrumb.Item>短信模版</Breadcrumb.Item>
                        </Breadcrumb>
                        <div className="page-top-button" >
                            <Button style={{ marginBottom: 16 }}><Link to="/smstemplateaction">新增</Link></Button>
                        </div>
...
const SMSTemplateFrom = Form.create()(SMSTemplate);


export default SMSTemplateFrom;