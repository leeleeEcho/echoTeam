...
class FinanceOrderRefund extends Component {
    constructor(props) {
        super(props)
        this.state = {
            curPage: 1,
    ...
    render() {
        ...
        return (
            <Layout className="page-layout">
                ...
                <Layout>
                    <FinanceMenu selected={['3']} />
                    <Layout style={{ padding: '0 24px 24px' }}>
                        <Breadcrumb style={{ margin: '16px 0' }}>
                            <Breadcrumb.Item>财务系统</Breadcrumb.Item>
                            <Breadcrumb.Item>待退款订单</Breadcrumb.Item>
                        </Breadcrumb>
...
const FinanceOrderRefundFrom = Form.create()(FinanceOrderRefund);


export default FinanceOrderRefundFrom;