...
class FinanceOrderFinish extends Component {
    constructor(props) {
        super(props)
        this.state = {
            curPage: 1,
...
const FinanceOrderFinishFrom = Form.create()(FinanceOrderFinish);


export default FinanceOrderFinishFrom;