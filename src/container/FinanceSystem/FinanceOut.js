...
class FinanceOut extends Component {
    ...
    render() {
        ...
        let columns = [
            ...
            { title: '成本价', dataIndex: 'capacity' },
            { title: '成本总价', dataIndex: 'price' },
        ...
        return (
            <Layout className="page-layout">
                ...
                <Layout>
                    <FinanceMenu selected={['7']} openKeys={['sub2']} />
                    <Layout style={{ padding: '0 24px 24px' }}>
                        <Breadcrumb style={{ margin: '16px 0' }}>
                            <Breadcrumb.Item>进出账管理</Breadcrumb.Item>
                            <Breadcrumb.Item>出账管理</Breadcrumb.Item>
                        </Breadcrumb>
                        <div className="page-top-button" >
                            <Button style={{ marginBottom: 10 }}><Link to="/financeoutaction">新增</Link></Button>
                        </div>
