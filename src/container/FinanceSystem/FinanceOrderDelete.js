...
class FinanceOrderDelete extends Component {
    constructor(props) {
        super(props)
        this.state = {
            curPage: 1,
    ...
    render() {
        ...
        return (
            <Layout className="page-layout">
                ...
                <Layout>
                    <FinanceMenu selected={['5']} />
                    <Layout style={{ padding: '0 24px 24px' }}>
                        <Breadcrumb style={{ margin: '16px 0' }}>
                            <Breadcrumb.Item>财务系统</Breadcrumb.Item>
                            <Breadcrumb.Item>已删除订单</Breadcrumb.Item>
                        </Breadcrumb>
...
const FinanceOrderDeleteFrom = Form.create()(FinanceOrderDelete);


export default FinanceOrderDeleteFrom;