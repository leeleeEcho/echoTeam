                                ...
                                <TabPane tab="基本信息" key="1">
                                    <Form className="page-content-form newTracklogform" onSubmit={this.handleSearch}>
                                        ...
                                        <Row >
                                            ...
                                            <Button type="primary" htmlType="submit" style={{ marginLeft: 20, marginTop: 20 }} ><Link to='/productlist'>返回</Link></Button>
                                        </Row>
                                    </Form>
                                </TabPane>
...
const ProductListEditFrom = Form.create()(ProductListEdit);


export default ProductListEditFrom;