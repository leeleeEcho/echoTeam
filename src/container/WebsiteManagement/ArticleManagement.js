    ...
    render() {
        ...
        return (
            <Layout className="page-layout">
                ...
                <Layout>
                    <WebsiteMenu selected={['6']} openKeys={['sub5']} />
                    <Layout style={{ padding: '0 24px 24px' }}>
                        ...
                        <div className="page-top-button page-content-form" >
                            <ButtonGroup>
                                <Button><Link to="/articlemanagementadd">新增</Link></Button>
                                <Button>全选</Button>
                                <Button>删除</Button>
                            </ButtonGroup>
                            <Select
...
const ArticleManagementFrom = Form.create()(ArticleManagement);


export default ArticleManagementFrom;