...
class CompanyClassAdd extends Component {
    constructor(props) {
        super(props)
        this.state = {
                                ...
                                <TabPane tab="基本信息" key="1">
                                    <Form className="page-content-form newTracklogform" onSubmit={this.handleSearch}>
                                        ...
                                        <Row >
                                            ...
                                            <Button type="primary" htmlType="submit" style={{ marginLeft: 20, marginTop: 20 }} ><Link to='/companyclass'>返回</Link></Button>
                                        </Row>
                                    </Form>
                                </TabPane>
...
const CompanyClassAddFrom = Form.create()(CompanyClassAdd);


export default CompanyClassAddFrom;