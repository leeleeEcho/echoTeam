...
class ColumnManagementAdd extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    render() {
        ...
        return (
            <Layout className="page-layout">
                ...
                <Layout>
                    <WebsiteMenu selected={['6']} openKeys={['sub6']} />
                                ...
                                <TabPane tab="基本信息" key="1">
                                    <Form className="page-content-form newTracklogform" onSubmit={this.handleSearch}>
                                        ...
                                        <Row >
                                            ...
                                            <Button type="primary" htmlType="submit" style={{ marginLeft: 20, marginTop: 20 }} ><Link to='/columnmanagement'>返回</Link></Button>
                                        </Row>
                                    </Form>
                                </TabPane>
...
const ColumnManagementAddFrom = Form.create()(ColumnManagementAdd);


export default ColumnManagementAddFrom;