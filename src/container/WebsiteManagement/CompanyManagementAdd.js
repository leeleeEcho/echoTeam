...
class CompanyManagementAdd extends Component {
    constructor(props) {
        super(props)
        this.state = {
                                ...
                                <TabPane tab="基本信息" key="1">
                                    <Form className="page-content-form newTracklogform" onSubmit={this.handleSearch}>
                                        ...
                                        <Row >
                                            ...
                                            <Button type="primary" htmlType="submit" style={{ marginLeft: 20, marginTop: 20 }} ><Link to='/companymanagement'>返回</Link></Button>
                                        </Row>
                                    </Form>
                                </TabPane>
...
const CompanyManagementAddFrom = Form.create()(CompanyManagementAdd);


export default CompanyManagementAddFrom;