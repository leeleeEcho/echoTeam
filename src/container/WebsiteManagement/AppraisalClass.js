...
class AppraisalClass extends Component {
    constructor(props) {
        super(props)
        this.state = {
            curPage: 1,
        ...
        let columns = [
            ...
            { title: 'key', dataIndex: 'key', className: 'hide' },
            {
                title: '操作', dataIndex: 'actions', render: (text, record) => {
                    return (
                        <span>
                            <a><Link to='/videoclassadd'>修改</Link></a>
                        </span>
                    )
                }
            }
                ...
                <WebsiteMenu selected={['18']} openKeys={['sub13']} />
                    <Layout style={{ padding: '0 24px 24px' }}>
                        ...
                        <div className="page-top-button page-content-form" >
                            <ButtonGroup>
                                <Button><Link to="/appraisalclassadd">新增</Link></Button>
                                <Button>全选</Button>
                                <Button>删除</Button>
                            </ButtonGroup>
                        </div>
...
const AppraisalClassFrom = Form.create()(AppraisalClass);


export default AppraisalClassFrom;