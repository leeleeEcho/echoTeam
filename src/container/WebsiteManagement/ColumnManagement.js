...
class ColumnManagement extends Component {
    constructor(props) {
        super(props)
        this.state = {
            curPage: 1,
    ...
    render() {
        ...
        return (
            <Layout className="page-layout">
                ...
                <Layout>
                <WebsiteMenu selected={['7']} openKeys={['sub5']} />
                    <Layout style={{ padding: '0 24px 24px' }}>
                        ...
                        <div className="page-top-button page-content-form" >
                            <ButtonGroup>
                                <Button><Link to="/columnmanagementadd">新增</Link></Button>
                                <Button>全选</Button>
                                <Button>删除</Button>
                            </ButtonGroup>
                        </div>
...
const ColumnManagementFrom = Form.create()(ColumnManagement);


export default ColumnManagementFrom;