                ...
                <Layout>
                    ...
                    <Layout style={{ padding: '0 24px 24px' }}>
                        <Breadcrumb style={{ margin: '16px 0' }}>
                            <Breadcrumb.Item>鉴定管理</Breadcrumb.Item>
                        </Breadcrumb>
                        <div className="page-top-button page-content-form" >
                            <ButtonGroup>
                                <Button><Link to="/appraisalmanagementadd">新增</Link></Button>
                                <Button>全选</Button>
                                <Button>删除</Button>
                            </ButtonGroup>
                            <Select
...
const AppraisalManagementFrom = Form.create()(AppraisalManagement);


export default AppraisalManagementFrom;